...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 bg-[#050709] py-12 sm:py-16">
      <Container>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-8 lg:gap-12">
          ...
          <div className="space-y-4 md:col-span-5 lg:col-span-6">
            <Link
              href="/#home"
              className="group inline-block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8852F7] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050709] rounded"
            ...
            <p className="max-w-sm font-poppins text-sm leading-relaxed text-text/60">
            ...
            <ul className="flex flex-col gap-2.5 font-rajdhani text-sm font-bold uppercase tracking-wider">
              {NAV_LINKS.map((link) => (
                <li key={link.sectionId}>
                  <Link
                    href={`/#${link.sectionId}`}
                    className="text-text/75 transition-colors duration-300 hover:text-[#ef9d7a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8852F7] focus-visible:rounded"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        {/* ── Divider & Copyright ────────────────────────────────────── */}
        <div className="mt-12 border-t border-white/5 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between font-poppins text-xs text-text/40">
