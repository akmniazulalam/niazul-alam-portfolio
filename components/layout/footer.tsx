  ...
  return (
    <footer className="border-t border-white/[0.06] bg-[#050709] py-12 sm:py-16">
      <Container>
        ...
        {/* ── Divider & Copyright ────────────────────────────────────── */}
        <div className="mt-12 border-t border-white/[0.06] pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between font-poppins text-xs text-text/45">
