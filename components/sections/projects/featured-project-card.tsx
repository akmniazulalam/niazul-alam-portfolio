...
import { TbCheck, TbBrandGithub, TbExternalLink, TbLock } from "react-icons/tb";
    ...
    <div className="space-y-10 sm:space-y-12">
      ...
      <FadeUp amount={0.38}>
        <article className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 lg:p-10 transition-all duration-500 hover:border-[#8852F7]/30 hover:shadow-[0_0_50px_rgba(135,80,247,0.15)] active:border-[#8852F7]/30 active:shadow-[0_0_50px_rgba(135,80,247,0.15)] shadow-xl">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
            ...
            <div
              className={cn(
                "lg:col-span-6 flex flex-col gap-5",
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden rounded-2xl border border-white/10 shadow-lg">
                <Image
                  ...
                  className="object-cover transition-transform duration-700 group-hover:scale-102 group-active:scale-102"
                  loading="lazy"
                />
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                {project.links.map((link, linkIndex) => {
                  const isPrimary = linkIndex === 0 && !link.isPrivate;
                  const isGithub =
                    link.icon === "github" ||
                  ...
                  if (link.isPrivate) {
                    return (
                      <button
                        ...
                        type="button"
                        disabled
                        className="inline-flex min-h-11 cursor-not-allowed items-center justify-center gap-2 rounded-xl border border-white/5 bg-white/[0.02] px-5 py-2.5 font-poppins text-xs font-semibold text-text/30"
                        aria-label={`${link.label} (Private repository)`}
                      >
                    ...
                    <a
                      ...
                      aria-label={
                        isGithub
                          ...
                          : `Open ${link.label} for ${project.title}`
                      }
                    >
            ...
            <div
              className={cn(
                "lg:col-span-6 flex flex-col justify-between gap-6",
                ...
                <div className="space-y-2">
                  ...
                  <StaggerContainer staggerDelay={0.02} amount="some">
                    <ul
                      ...
                      aria-label={`${project.title} technologies list`}
                    >
      ...
      <FadeUp delay={0.1} amount={0.3}>
        <ProjectGallery
          ...
          altTexts={project.galleryAltTexts}
