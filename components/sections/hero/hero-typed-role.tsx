...
export function HeroTypedRole() {
  ...
  return (
    <h2 className="font-rajdhani text-3xl font-bold sm:text-3xl lg:text-5xl min-h-8 sm:min-h-9 lg:min-h-10 flex items-center justify-center lg:justify-start">
