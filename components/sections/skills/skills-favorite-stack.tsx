          ...
          >
            {favoriteStack.items.map((item, index) => (
              <li key={item.name} className="flex items-center gap-2 sm:gap-2.5">
                <span
                  tabIndex={0}
                  className="group inline-flex items-center gap-1.5 rounded-full border border-[#ef9d7a]/35 bg-[#ef9d7a]/10 px-3 py-1 font-poppins text-xs font-semibold text-[#ef9d7a] transition-all duration-300 hover:scale-105 hover:bg-[#ef9d7a]/20 hover:shadow-[0_0_15px_rgba(239,157,122,0.2)] active:scale-105 active:bg-[#ef9d7a]/20 active:shadow-[0_0_15px_rgba(239,157,122,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ef9d7a] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0909] sm:px-4 sm:py-1.5 sm:text-sm"
                >
                  <SkillsIcon
                    name={item.name}
                    className="size-3.5 shrink-0 transition-transform duration-300 group-hover:scale-110 group-active:scale-110 group-focus-visible:scale-110"
                  />
                  {item.name}
                </span>
