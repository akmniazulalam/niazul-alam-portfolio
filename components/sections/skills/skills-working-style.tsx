  ...
  return (
    <FadeRight className="h-full">
      <article
        ...
        className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:p-6 lg:p-8 h-full transition-all duration-300 hover:-translate-y-1 hover:border-[#8852F7]/40 hover:shadow-[0_0_30px_rgba(135,80,247,0.2)] active:-translate-y-1 active:border-[#8852F7]/40 active:shadow-[0_0_30px_rgba(135,80,247,0.2)]"
      >
        <h3
