...
function WorkingProcessCard({ step, index }: WorkingProcessCardProps) {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="mb-4 flex size-11 items-center justify-center rounded-xl border border-[#8852F7]/30 bg-[#8852F7]/10 transition-colors duration-300 group-hover:border-[#ef9d7a]/50 group-active:border-[#ef9d7a]/50 group-focus-visible:border-[#ef9d7a]/50"
      >
