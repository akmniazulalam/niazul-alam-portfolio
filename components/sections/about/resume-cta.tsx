      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:shrink-0">
          <a
            ...
            className={cn(
              buttonBaseStyles,
              "bg-[#FF014F] text-white shadow-lg shadow-[#FF014F]/15 hover:-translate-y-1 hover:bg-[#FF014F]/90 hover:shadow-[0_0_20px_rgba(255,1,79,0.4)] active:-translate-y-0.5 active:bg-[#FF014F]/90 active:shadow-[0_0_20px_rgba(255,1,79,0.4)]",
            )}
          >
            {buttonLabel}
          </a>
