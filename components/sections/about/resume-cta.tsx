      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:shrink-0">
          <a
            ...
            className={cn(
              buttonBaseStyles,
              "bg-[#FF014F] text-white shadow-lg shadow-[#FF014F]/15 hover:-translate-y-1 hover:bg-[#FF014F]/90 hover:shadow-[0_0_20px_rgba(255,1,79,0.4)] active:-translate-y-0.5 active:bg-primary/90 active:shadow-[0_0_20px_rgba(255,1,79,0.4)]",
            )}
          >
            {buttonLabel}
          </a>
          ...
          <a
            ...
            className={cn(
              buttonBaseStyles,
              "border border-[#ef9d7a]/40 bg-transparent text-text hover:-translate-y-1 hover:border-[#ef9d7a] hover:bg-[#ef9d7a]/10 hover:shadow-[0_0_20px_rgba(239,157,122,0.15)] active:-translate-y-0.5 active:border-[#ef9d7a] active:bg-[#ef9d7a]/10 active:shadow-[0_0_20px_rgba(239,157,122,0.15)]",
            )}
          >
            {secondaryButtonLabel}
          </a>
